...
export const inputVariants = cva(
  [
    "h-9.5 px-3.5 w-full text-[16px] md:text-base text-foreground rounded placeholder:text-base placeholder:text-dimmed transition-[color,box-shadow] shadow-input",
