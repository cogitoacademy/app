...
export const textareaVariants = cva(
  [
    "min-h-28 w-full resize-y px-3.5 py-2.5 text-[16px] md:text-base text-foreground rounded placeholder:text-base placeholder:text-dimmed transition-[color,box-shadow] shadow-input",
