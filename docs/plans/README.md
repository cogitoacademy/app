...
| [BACKEND-HARDENING.md](active/BACKEND-HARDENING.md)   | `main` (5 focused PRs A–E)       | —   | CI/deps-bot, local-test parity, correctness, test realignment, plan sync |
| [PRD-GAPS-SPEC.md](active/PRD-GAPS-SPEC.md)           | `feature/prd-gaps` (future)      | —   | Backend gaps (G1-G20), next to execute                                   |
