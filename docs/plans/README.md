...
| ------------------------------------------------------------------- | ---------------------------------- | --- | ----------------------------------------- |
| [PRODUCTION-READINESS-PLAN.md](active/PRODUCTION-READINESS-PLAN.md) | `improvement/production-readiness` | #18 | Open — bug fixes, Redis, DB opt, security |
| [INFRASTRUCTURE-PLAN.md](active/INFRASTRUCTURE-PLAN.md)             | `improvement/infrastructure`       | #19 | Open — Dockerfiles, CI/CD, Coolify, bots  |
| [PRD-GAPS-SPEC.md](active/PRD-GAPS-SPEC.md)                         | `feature/prd-gaps` (future)        | —   | Reference spec, after #18 + #19 merge     |
