...
Audit of git HEAD `9b7df5e` against the PRD (FR/DL/TC refs). These are newly discovered gaps found *after* G1–G20 merged. They are **folded into `docs/plans/active/BACKEND-HARDENING-PHASE2.md` PR 5**, not this spec's G-series.
