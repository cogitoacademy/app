...
| Field      | Value                                                                                                                                                                                                                                                                                                                                                                                           |
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Status     | Living gap inventory (updated 2026-09-23; F1/F8/F9/F13/F14/F18 closed; F16 scope retired; F2/F3/F6/F7/F11/F17 closed by merged PR #55; F12 closed; competition taxonomy, tutor-achievement-format, and tutor-onboarding-layout follow-ups implemented; meeting fallback and admin wallet-search follow-ups added; separate admin tutor payout workspace and room detail controls added; production UI/E2E audit verified) |
...
### Tutor onboarding field-layout follow-up (2026-09-23)

Tutor onboarding now uses shared responsive rows with labels and descriptions on
the left and controls, validation messages, and dynamic add-entry actions on the
right. Teaching setup and payout cards are one full-width sequence, capacity
selectors and base-honorarium steppers fill their control column, and
specialization categories and options use one vertical column. RPC, schema,
