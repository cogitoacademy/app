...
- Integration: packages/api/src/tests/integration/economy-roles.test.ts — 4 passed.
- Browser E2E: packages/e2e/src/specs/economy-roles.spec.ts — 3 passed (student, tutor, admin).
