...
\begin{tabular}{|p{3cm}|p{3cm}|p{8.2cm}|}
	...
	\hline
1.5              & August 22, 2026  & Incorporated the client-provided Marks Economy, Regulatory Compliance \& Engineering Blueprint dated August 15, 2026: IDR-denominated tutor honoraria, fixed online/offline Cogito take schedules, revised Marks packages, Rp5,000 computational value, and direct IDR tutor compensation. \\
\hline
...
\hline
1.7              & August 23, 2026  & Moved Competition Calendar and Knowledge Bank delivery into the authenticated app while retaining Sanity as the editorial source of truth; the bilingual academy landing page now uses login CTAs with return paths. \\
\hline
\end{tabular}
...
\hline
DL-03 & August 23, 2026 & Competition Calendar and Knowledge Bank are delivered inside the authenticated app, while Sanity remains the editorial source of truth and the bilingual academy landing page remains the public CTA surface. & Final \\
\hline
...
\hline
DL-15 & August 15, 2026 & Tutor tier-based pricing and Marks-denominated tutor self-pricing are removed from Phase 0. Tutors set an IDR base honorarium for each supported modality in Rp5,000 increments; group honoraria are derived from the fixed online/offline increment schedule. & Final \\
\hline
DL-16 & June 1, 2026 & Knowledge Bank access requires student login and at least 35 total Marks in the wallet; authenticated tutors and admins may access it without a Marks threshold. This is an eligibility threshold for students, not a 35-Mark fee. & Final \\
\hline
...
\hline
DL-22 & August 15, 2026 & The active online/offline schedules define the Cogito take in IDR. They are initialized from the client-approved defaults and may be changed by an admin for future bookings only; the tutor honorarium remains the tutor's IDR base rate plus the modality-specific per-student increment. Student-facing booking prices are derived by converting the total IDR to Marks at the Rp5,000 computational value and rounding up per student. & Final \\
\hline
...
\hline
DL-27 & August 15, 2026 & Marks are closed-loop prepaid learning credits. The computational value is Rp5,000 per Mark; approved package prices range from Rp6,250 per Mark down to Rp5,000 per Mark, with the package premium retained by Cogito as platform spread. & Final \\
\hline
...
\hline
DL-29 & August 22, 2026 & Admin may edit the active Cogito take schedule in Rp5,000 increments with optimistic version control. The change is audited and applies only when a new booking or repricing snapshot is created; a booking's persisted snapshot is immutable for ordinary rate changes. & Final \\
\hline
\end{longtable}
\normalsize
...
\begin{itemize}
    \item \textbf{OQ-01: Resolved.} The client-approved package structure is Starter 50 Marks / Rp312,500, Learner 120 Marks / Rp690,000, Explorer 200 Marks / Rp1,070,000, and Pioneer 400 Marks / Rp2,000,000. These values supersede all earlier package drafts.
...
\item authenticated Competition Calendar and Knowledge Bank app surfaces backed by the existing Sanity content,
...
\item a separate public Knowledge Bank page outside the authenticated app,
...
\item a second editorial database for Competition Calendar or Knowledge Bank content,
...
\hline
Public & Existing bilingual public landing page remains in place; approved achievements may be surfaced there. Calendar and Knowledge Bank CTAs send visitors to app login with an internal return path; the content itself is authenticated. \\
\hline
Student & Login / signup, dashboard, wallet and Marks purchase, tutor discovery, tutor profile, solo and group booking flow, booking detail / history, report tutor lateness / no-show action, notifications, achievements submission, authenticated Competition Calendar, 35-Mark-gated Knowledge Bank, and WhatsApp support button. Public signup creates student / default access only and cannot create tutor access. \\
\hline
Tutor & Invite acceptance, account claim, onboarding, dashboard, IDR honorarium setup and breakdown, payout request / payroll status, availability management, incoming bookings, booking detail, reschedule proposal, session completion, session notes, and authenticated Knowledge Bank access without a Marks threshold. \\
\hline
Admin & Login, dashboard, user lookup, tutor invitation, tutor onboarding review, booking monitor, booking detail and state history, wallet / ledger view, override / reconciliation, tutor honorarium review, economy settings, achievement moderation, audit review, and authenticated Knowledge Bank access without a Marks threshold. \\
\hline
\end{tabular}
...
\hline
Set own tutor base honorarium & No & Yes & Yes & Tutors set IDR base honoraria for supported modalities in Rp5,000 increments, with a minimum of Rp50,000; admin can review or correct exceptions. \\
\hline
Manage active Cogito take schedule & No & No & Yes & Admin edits online/offline base take and per-student increments in Rp5,000 increments; changes are audited and affect future booking snapshots only. \\
\hline
...
\begin{longtable}{|L{1.5cm}|L{4.1cm}|L{9.0cm}|}
	...
	\hline
	FR-04           & As a student, I want to buy Marks through a payment provider so I can fund bookings.                                   & \textbf{Requirement:} The system shall support Marks purchase through an external payment integration and the client-approved package pricing. \newline \textbf{Acceptance:} Successful payment increases balance and records a receipt; failed or pending payments do not credit Marks. The package cards show Starter Pack (50 Marks / Rp312,500), Learner Pack (120 Marks / Rp690,000), Explorer Pack (200 Marks / Rp1,070,000), and Pioneer Pack (400 Marks / Rp2,000,000).                                                                                                                                                                                                                                                                                                                                                                 \\
	\hline
	FR-05           & As an admin, I want tutor honoraria and Cogito fees to follow the approved economic model.                                         & \textbf{Requirement:} The system shall validate tutor base honoraria in IDR and calculate class costs from the active admin-managed modality schedules. \newline \textbf{Acceptance:} Admin can review tutor base honoraria; each supported modality accepts values no lower than Rp50,000 and only in Rp5,000 increments; online honorarium increases by Rp30,000 per additional student, offline honorarium increases by Rp40,000, online Cogito take is Rp50,000 plus Rp20,000 per additional student, and offline Cogito take is Rp90,000 plus Rp40,000 per additional student.                                                                                                                                                                                                                                                                                                                                 \\
	\hline
	...
	\hline
FR-11           & As a user, I want access to Competition Calendar after signing in.                                 & \textbf{Requirement:} The system shall expose the published Competition Calendar inside the authenticated app for every signed-in role while keeping Sanity as the editorial source of truth. The bilingual public academy site shall provide login CTAs with a calendar return path. \newline \textbf{Acceptance:} A signed-in user can browse the English app calendar without a Marks condition; public academy calendar URLs redirect to app login; the existing Sanity content remains authoritative.                                                                                                                                                                                                                                                                                                                                         \\
	\hline
	FR-12           & As a student, I want clear Knowledge Bank access rules so I know when content is available.                                           & \textbf{Requirement:} The system shall provide the Knowledge Bank inside the authenticated app, backed by the existing Sanity source, and gate student access by login plus wallet threshold while allowing authenticated tutors and admins to access the same resources without that student threshold. \newline \textbf{Acceptance:} Student access is available only after signing into the student dashboard and only if the student's wallet has at least 35 total Marks; tutor and admin access is available after authentication regardless of wallet balance. The UI must state clearly that 35 Marks is a minimum student wallet-balance requirement, not a 35-Mark access fee, opening the Knowledge Bank must not deduct Marks, and resource files must be served only through an authenticated app path.                                                                                                                                                                                                                                                                                                                                                                 \\
	\hline
...
\begin{itemize}
    ...
    \item IDR base honorarium for each supported modality, validated for the Rp50,000 minimum and Rp5,000 increments,
...
\begin{itemize}
    ...
    \item All four package values are approved for Phase 0 seed data: Starter 50 Marks / Rp312,500, Learner 120 Marks / Rp690,000, Explorer 200 Marks / Rp1,070,000, Pioneer 400 Marks / Rp2,000,000.
\end{itemize}

\textbf{Approved package table}

The following package table is the approved Phase 0 wallet top-up structure. Package prices are the amount charged to the student. The Rp5,000 computational value is used for booking economics; any package premium above that value is retained by Cogito as platform spread at purchase.
...
\hline
Starter Pack & 50 Marks & Rp6,250 & Rp312,500 & Rp62,500 (20.0\%) \\
\hline
Learner Pack & 120 Marks & Rp5,750 & Rp690,000 & Rp90,000 (13.0\%) \\
\hline
Explorer Pack & 200 Marks & Rp5,350 & Rp1,070,000 & Rp70,000 (6.5\%) \\
\hline
Pioneer Pack & 400 Marks & Rp5,000 & Rp2,000,000 & Rp0 (volume baseline) \\
\hline
\end{tabular}
...
\begin{itemize}
    \item Computational value: 1 Mark = Rp5,000 for class pricing, Cogito take calculations, and conversion calculations.
    \item Student acquisition rates vary by package size from Rp6,250 / Mark down to Rp5,000 / Mark.
    \item The difference between the package purchase price and the Marks' Rp5,000 computational value is platform spread retained by Cogito at purchase.
...
\begin{itemize}
	...
	\item Students purchase Marks in approved packages: Starter 50 Marks / Rp312,500, Learner 120 Marks / Rp690,000, Explorer 200 Marks / Rp1,070,000, Pioneer 400 Marks / Rp2,000,000.
	...
	\item Knowledge Bank access checks wallet balance continuously for students and requires at least 35 Marks; authenticated tutors and admins are not subject to this threshold.
...
\begin{itemize}
    \item Students must be signed in and inside the student dashboard; tutors must be authenticated in the tutor workspace.
    \item Students require a minimum wallet balance of 35 Marks; tutors and admins have access without a wallet threshold.
    ...
    \item A student below 35 Marks loses Knowledge Bank access until they top up or admin correction restores balance; this restriction does not apply to tutors or admins.
\end{itemize}
...
\begin{itemize}
    ...
    \item Tutors configure an IDR one-student base honorarium for each supported modality. The value must be at least Rp50,000 and must use Rp5,000 increments.
    \item Admin configures the active Cogito take schedule: online base Rp50,000 and increment Rp20,000; offline base Rp90,000 and increment Rp40,000 by default. Each editable value uses Rp5,000 increments; increments may be zero but may not be negative.
    \item When an admin changes any active Cogito take value, every current tutor account receives a durable in-app notification describing the new online/offline schedule. Re-saving identical values is a no-op and does not create a new version, audit event, or notification.
    \item The default one-student base honorarium is Rp175,000 for online classes and Rp225,000 for offline classes.
...
\begin{itemize}
    \item Extreme low end, junior online tutor at a Rp75,000 base rate: 1 student produces Rp125,000 total or 25 Marks; 4 students produce Rp275,000 total or 55 Marks, which bills as 14 Marks per student.
    \item Extreme high end, specialist offline masterclass at a Rp500,000 base rate: 1 student produces Rp590,000 total or 118 Marks; 6 students produce Rp990,000 total or 198 Marks, which bills as 33 Marks per student.
...
\begin{itemize}
    ...
    \item Final total Marks = final total IDR / Rp5,000; Marks per student = $\lceil$ final total Marks / confirmed headcount $\rceil$; actual Marks pooled = Marks per student $\times$ confirmed headcount.
...
\hline
Active Cogito take schedule changed & Yes & No & Notify every current tutor in-app; applies to future booking/repricing snapshots only. Identical saves do not emit a notification. \\
\hline
...
\begin{itemize}
    ...
    \item If automatic meeting creation fails, the booking remains valid but shows ``meeting link pending'' to the assigned tutor, admin, and affected users. The assigned tutor or an admin may add a manual meeting link as any valid URL, including Google Meet, Zoom, or another approved provider.
...
\begin{longtable}{|L{1.2cm}|L{3.3cm}|L{3.9cm}|L{6.0cm}|}
	...
	\hline
	TC-05          & Verify tutor honorarium constraints and Cogito schedules.                      & Tutor can edit base honoraria; admin can review them and edit the active Cogito take schedule.                                    & 1. Try to publish a base honorarium below Rp50,000 or outside Rp5,000 increments. 2. Publish valid online and offline base honoraria. 3. Inspect the derived class-size breakdown. \newline Invalid IDR values are rejected, valid values produce the active modality increments for class sizes 1--6, and no tier-based pricing or Marks cash-out rate is used.                                                                                                                                                                       \\
	\hline
	TC-06          & Verify IDR honorarium, Cogito take, and Marks conversion.         & Tutor has the default online base honorarium of Rp175,000 and default offline base honorarium of Rp225,000.                                        & 1. Calculate online class for 1 and online class for 3. 2. Calculate offline class for 1 and offline class for 3. 3. Inspect the stored economic snapshot and student hold. \newline Online class for 1 is Rp175,000 tutor honorarium + Rp50,000 Cogito take = Rp225,000 = 45 Marks. Online class for 3 is Rp235,000 + Rp90,000 = Rp325,000 = 65 total Marks = 22 Marks per student and 66 actual Marks pooled. Offline class for 1 is Rp225,000 + Rp90,000 = Rp315,000 = 63 Marks. Tutor compensation remains an IDR honorarium and is not calculated as Marks cash-out.                                                                                                                                                                    \\
	\hline
...
\begin{itemize}
    ...
    \item Implement the booking, Marks ledger, and override domains test-first. The highest-risk rules are 12-hour response windows, IDR honorarium and Cogito take calculations, Rp5,000 Marks conversion and per-student rounding, no Marks-to-rupiah conversion, admin-verified tutor no-show return, and payment-error reconciliation.
...
\begin{itemize}
	...
	\item \textbf{Computational Mark Value}: Rp5,000 used to calculate class totals and convert IDR economics into Marks.
	\item \textbf{Marks Acquisition Rate}: the package-specific student purchase price per Mark, ranging from Rp6,250 to Rp5,000.
	\item \textbf{Platform Spread}: the difference between the student's package purchase price and the Marks' Rp5,000 computational value, retained by Cogito at purchase.
	\item \textbf{Tutor Base Honorarium}: the tutor-configured one-student IDR honorarium for a supported modality, in Rp5,000 increments and no lower than Rp50,000.
...
\item \textbf{Editorial content source of truth}: the existing Sanity CMS that owns Competition Calendar and Knowledge Bank content, with authenticated app delivery.
\end{itemize}
...
% Build-tolerant include: renders a placeholder box when the diagram PNG is
% absent so `latexmk` (local `make prd-pdf` and the prd-pdf workflow) still
% produces docs/prd.pdf. No product meaning changes when the file exists.
\begin{center}
\IfFileExists{diagrams/booking-flow.png}{\includegraphics[width=\linewidth,height=0.92\textheight,keepaspectratio]{booking-flow.png}}{\fbox{\parbox{0.9\linewidth}{\centering Diagram placeholder: booking-flow (add diagrams/booking-flow.png).}}}
\end{center}

\textbf{Booking state machine}

\begin{center}
\IfFileExists{diagrams/booking-state-machine.png}{\includegraphics[width=\linewidth,height=0.92\textheight,keepaspectratio]{booking-state-machine.png}}{\fbox{\parbox{0.9\linewidth}{\centering Diagram placeholder: booking-state-machine (add diagrams/booking-state-machine.png).}}}
\end{center}
