...
| `docs/plans/active/DEFERRED-OPS-TASKS.md`                         | main (post-merge)                                                                   | Active — code gaps 1.1–1.8 done (1.4 now 0 bare selects); §2 Redis session caching deferred; §3/§4 ops pending (4.3 monitoring live 2026-09-02: Kuma + status page + Discord; built-in health checks + §4.4 remain operator console)                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
