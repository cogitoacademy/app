...
On narrow screens, the rounded booking status-tab strip fills the available page width; only its inner tab list scrolls horizontally, with the native scrollbar hidden. This is presentation-only and does not change the `booking.listMine` contract.
...
The booking proposer may propose or counter a time in the eligible pre-terminal states, including `confirmed` and `scheduled`, subject to the student H-2 checks. A force-majeure or other emergency exception is not an automatic student reschedule after H-2; it must be handled through support/admin operations with an auditable reason and any applicable Marks decision.
...
| `docs/plans/active/DEPLOYMENT-PLAN.md`                            | main (merged #115–#118)                                                             | **Active (rev. 2)** — infra scaffold (#115), DLQ health (#116), nightly backups (#117), CD pipeline (#118) merged; wave-2 repo work (#121) merged; operator apply + secrets pending (webhook 401: Traefik route + optional Bearer)                                                                                                                                                                                                                                                                                                              |
| `docs/plans/active/DEPLOYMENT-WAVE-2.md`                          | main (merged #121)                                                                  | **Active (wave-2, merged 2026-08-28)** — coolify-resources playbook + Traefik deploy-webhook route, drift-check playbook, plan-only CI audit (#121); operator steps pending (SOPS encrypt, R2, terraform apply, ansible applies, GitHub secrets)                                                                                                                                                                                                                                                                                                |
| `docs/plans/completed/DEPLOYMENT-DISPATCH.md`                     | main (merged #115–#118)                                                             | **Completed (2026-08-28)** — wave-1 dispatch brief; superseded by DEPLOYMENT-WAVE-2.md (moved to completed/)                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
15. Deployment Wave 2 (DEPLOYMENT-WAVE-2.md — coolify-resources playbook + Traefik 401 fix, drift-check, plan-only CI audit) → **merged #121 (2026-08-28); operator apply + secrets pending**
