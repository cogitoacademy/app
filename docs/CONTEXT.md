...
| `docs/plans/completed/OBS-ALERT-LATCH-IMPORTANT-LOGS.md`           | `fix/obs-alert-latch-important-logs`                                                | **Completed (merged #249, 2026-09-14)** — un-latched all 14 Grafana alerts (zero-safe queries, Normal NoData, internal-job exclusion, 3 never-fire fixes) + replaced Payment Logs board with Important Logs |
