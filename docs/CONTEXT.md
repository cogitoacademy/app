...
| `docs/plans/active/DEPLOYMENT-DISPATCH.md`                        | main (merged #115–#118)                                                             | **Executed 2026-08-27** — PR A (#115), PR B (#116), W1 (#118), W2 (#117) all merged; kept as the historical brief record                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
