...
zero-safe queries (thresholds in the C step) with `noDataState: Normal`;
...
`docs/plans/active/OBS-ALERT-LATCH-IMPORTANT-LOGS.md` and RUNBOOK →
Monitoring & Alerting.
...
**Remaining (see `docs/plans/active/`):** drills (DEPLOYMENT-PLAN Phase 5), Xendit go-live, and `ACTIONS_BOT_PAT` keep-or-drop (operator). p95 baseline via the App-RED dashboard after 7 days.
...
| `docs/plans/active/OBS-ALERT-LATCH-IMPORTANT-LOGS.md`             | `fix/obs-alert-latch-important-logs`                                                | **Active (2026-09-14)** — un-latch all 14 Grafana alerts (zero-safe queries, Normal NoData, internal-job exclusion, 3 never-fire fixes) + replace Payment Logs board with Important Logs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
24. Observability Alert-Latch + Important Logs (OBS-ALERT-LATCH-IMPORTANT-LOGS — zero-safe alert queries with Normal NoData, TargetDown internal exclusion, 3 never-fire fixes; Payment Logs board replaced by Important Logs) → **this wave (`fix/obs-alert-latch-important-logs`)**
```
