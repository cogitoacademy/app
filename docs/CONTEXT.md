...
**Remaining (see `docs/plans/active/`):** Uptime Kuma + Discord alerting (MONITORING-ALERTING — box is wired), drills (DEPLOYMENT-PLAN Phase 5), Xendit go-live, branch protection + `ACTIONS_BOT_PAT` (CI-SANITY F9/F10), lint wave (81 oxlint-1.80 findings, toolchain pinned to 1.78/0.63 meanwhile).
