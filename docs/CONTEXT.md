...
| `docs/plans/active/WAVE-6-REVIEW-FIXES.md`                        | `fix/wave6-review-fixes` (future PR) | Active (2026-08-19) — wave-5 review findings H1–H3/M1–M5/L1–L2 open, L3 partial; N1–N4 added by wave-6 deep review (re-verified @ `69e2dd8`); **M2+N1 fixed by wave-6a worker** (`adminRefund` is in-app Marks credit only — no provider cash refund) |
