...
| `docs/plans/active/PRD-GAPS-PHASE3.md`                            | main (merged)                      | **Completed (2026-08-16)** — all U-items closed via REVIEW-FIXES-3 (P3.8/P5)                                                                              |
...
| `docs/plans/active/FRONTEND-GAPS-SPEC.md`                         | main (merged #55)                  | Active — F2/F3/F6/F7/F11/F17 landed via #55; F8/F13/F14/F16 + C6 closed via REVIEW-FIXES-3 P6; G2/J2/F18-withdraw open                                    |
| `docs/plans/completed/REVIEW-FIXES-3.md`                          | main (merged #60–#65)              | Completed (2026-08-16) — wave-3 audit fixes landed: docs sync, PR #55 blockers reported, backend money B1–B9, CI/CD C1–C9, U-items, frontend F-items + C6 |
...
9. PRD Gaps Phase 3 (PRD-GAPS-PHASE3.md) + Frontend Gaps (FRONTEND-GAPS-SPEC) → PRD-GAPS-PHASE3 closed via REVIEW-FIXES-3; FRONTEND-GAPS-SPEC mostly landed (#55 + P6)
10. Review Fixes 3 (REVIEW-FIXES-3.md — docs, money fixes B1–B9, CI/CD C1–C9, U-items, F-items) → **completed (merged via #60–#65)**
