...
| `docs/plans/active/CPU-MEMORY-PRESSURE-WAVE.md`                   | w/cpu-memory-pressure-wave (pressure + alerts)                                      | **Active (2026-09-07)** — swap-thrash relief (cAdvisor 256m + disk trim, Alloy self-scrape, backup-log shipping), KeepLast on all 12 rules, swap panel                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
22. CPU/Memory Pressure Wave (CPU-MEMORY-PRESSURE-WAVE — cAdvisor OOM relief, Alloy self-scrape, backup-log shipping, KeepLast alerts, swap panel) → **Active (2026-09-07)**
```
