...
| `docs/plans/active/INFRA-RELIABILITY-WAVE.md`                      | w/infra-reliability-* (3 worktrees)                                                 | **Active (2026-09-07)** — infra reliability wave plan + accepted risks + next-session restore-drill checklist; studio gateway, lean-fallback retention, dual scrape, SOPS_AGE_KEY-in-CI risk, origin-bypass groundwork; docs sync (this branch owns all *.md edits, prod/obs workers touch no docs)                                                                                                                                                                                                                                                                                                                                                                                                    |
