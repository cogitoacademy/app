...
| `docs/plans/active/FRONTEND-GAPS-SPEC.md`                         | `f/f9-session-notes` (follow-up)                                                    | Active — F9 session notes editor/rendering is complete; F1/F18 remain partial; F12 room approval queue implemented; booking detail meeting/activity UX refined 2026-08-22 |
...
11. Frontend Gaps (FRONTEND-GAPS-SPEC — F8/F9/F13/F14/F16 closed; F2/F3/F6/F7/F11/F17 closed by merged #55; F12 room approval queue implemented; F1/F18 partial) → after / parallel with #10
...
**Not full PRD complete:** group/series booking UI, invite confirmation/decline/reconfirmation UI, reschedule accept/reject UI (F7), lateness/no-show reporting UI (F3), and public achievements (F16) remain open. Backend support for reschedule accept/reject and lateness/no-show reporting (G1/G6) has landed. The notification center, Knowledge Bank gating UX, email verification, and session-expiry warning are implemented. (2026-08-22: F9 rich-text session notes are now complete; J2 session-expiry UX now warns during the final 30 minutes and retains the existing 401 redirect; remaining open items are tracked in FRONTEND-GAPS-SPEC: F1/F18 partial.)
