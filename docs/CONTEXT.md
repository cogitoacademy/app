...
| `docs/plans/active/DEPLOYMENT-PLAN.md`                            | main (merged #115–#118)                                                             | **Active (rev. 2)** — infra scaffold (#115), DLQ health (#116), nightly backups (#117), CD pipeline (#118) merged; operator apply tooling added on `ops/apply-tooling` (infra/apply.sh — one-command wrapper + `--dry-run`, marker-gated, see `infra/APPLY-RUNBOOK.md` §0); vault/secrets population + webhook-auth verification (401 under investigation) remain pending                                                                                                                                                                                                                                                                                                                                                                                                     |
| `docs/plans/active/DEPLOYMENT-WAVE-2.md`                          | main (merged #121–#122)                                                             | **Active (wave-2, 2026-08-28)** — Coolify resources, Traefik routing, drift check, plan-only CI, and production backup/env wiring merged; operator apply tooling (infra/apply.sh) added on `ops/apply-tooling` (2026-08-31); vault/secrets population and webhook-auth verification pending                                                                                                                                                                                                                                                                                                                                                            |
