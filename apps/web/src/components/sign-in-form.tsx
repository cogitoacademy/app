    ...
    <div className="w-full flex items-center justify-center p-4 lg:min-h-[calc(100svh-4rem)]">
      <Card className="w-full lg:w-5/12 xl:w-md">
        ...
        <CardBody className="flex flex-col gap-5">
          ...
          <Divider variant="center" className="my-2">Or continue with email</Divider>
      <form
        onSubmit={(e) => {
          e.preventDefault();
          e.stopPropagation();
      ...
      >
          ...
          {(field) => (
              <Field>
                <div className="flex items-center">
                  ...
                  <TextLink href="#" className="ml-auto">Forgot password?</TextLink>
                </div>
                <Input
                  id={field.name}
                  name={field.name}
        ...
        >
          ...
          <Text className="text-center">
            Don&apos;t have an account? <TextLink render={<button type="button" onClick={onSwitchToSignUp} />}>Sign up</TextLink>
          </Text>
        </CardBody>
      </Card>
    </div>
